...
var ResourUploader = (_dec = (0, _mobxReact.inject)('store'), _dec(_class = (0, _mobxReact.observer)(_class = function (_React$Component) {
  (0, _inherits3.default)(ResourUploader, _React$Component);

  function ResourUploader(props) {
    (0, _classCallCheck3.default)(this, ResourUploader);

    var _this = (0, _possibleConstructorReturn3.default)(this, (ResourUploader.__proto__ || (0, _getPrototypeOf2.default)(ResourUploader)).call(this, props));
  ...
  (0, _createClass3.default)(ResourUploader, [{
  ...
  return ResourUploader;
}(_react2.default.Component)) || _class) || _class);
exports.default = ResourUploader;